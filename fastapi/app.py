...
if _actual_module is not None:
    ...
    class APIRouter:
        ...
        def get(
            self, path: str, response_model: Any = None
    ...
    class FastAPI:
        ...
        def __init__(
            ...
            lifespan: Optional[Callable[["FastAPI"], Awaitable[Any]]] = None,
        ):
            self.title = title
                ...
                for name, parameter in signature.parameters.items():
                    ...
                    if parameter.kind in (
                        ...
                        if name in path_params:
                            kwargs[name] = self._coerce_value(
                        ...
                        if parameter.annotation and isinstance(request.json(), dict):
                            ...
                            if inspect.isclass(parameter.annotation) and issubclass(
                                parameter.annotation, BaseModel
                            ):
                        ...
                        if not assigned and name in request.query_params:
                            ...
                            kwargs[name] = self._coerce_value(
                                raw_value, parameter.annotation
                            )
                            assigned = True
                        if not assigned:
                            kwargs[name] = None
        ...
        def _resolve_dependency(
            self, dependency: Callable[..., Any], request: Request
