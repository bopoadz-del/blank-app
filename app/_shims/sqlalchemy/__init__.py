"""Lightweight fallback implementation for the SQLAlchemy package."""
...
class OperationalError(Exception):
    """Simplified stand-in for SQLAlchemy's OperationalError."""
...
def create_engine(url: str, **kwargs: Any) -> Engine:  # noqa: ARG001 - API parity shim
    return Engine()
